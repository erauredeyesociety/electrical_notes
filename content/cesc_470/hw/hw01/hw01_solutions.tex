...
% Upload /home/devel/electrical_notes/content/cesc_470/hw/hw01/overleaf/hw01_solutions.tex instead -- docs/latex/flatten_tex.sh writes it.
...
% Both text columns are ragged right: justifying them stretched "Decode
% complexity" across the cell and hyphenated "performance-per-watt".
\begin{tabular}{@{}p{0.5cm}>{\raggedright\arraybackslash}p{3.9cm}>{\raggedright\arraybackslash}p{10.3cm}@{}}
  \toprule
...
\noindent\textbf{(b)} $\;\CPUtime = \IC \times \CPI \times \cycletime

...
from instructions being *indistinguishable from data*, since that single fact
...
instructions to CPU operations'' \srcref{PDF p16} — a mapping over *stored*
bit patterns.
...
sequences stored in ordinary read/write memory, so a new program is *loaded*

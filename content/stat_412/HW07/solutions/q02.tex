...
\textbf{Part (c).} If the question asks for power, use $1-\beta$:
\[
1-0.8695=0.1305,\qquad 1-0.8454=0.1546.
\]

\subsection*{Final Answer}

\fbox{\begin{minipage}{0.94\linewidth}
$\alpha=0.0609$. For $p=0.3$, $\beta=0.8695$ and power $=0.1305$. For $p=0.5$, $\beta=0.8454$ and power $=0.1546$.
\end{minipage}}

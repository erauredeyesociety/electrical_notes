...
| [`coursework_preamble.tex`](../../../docs/latex/coursework_preamble.tex) | LaTeX | The shared preamble. Every problem file `\input`s it. Course-specific *notation* goes in this course's own `cpsc_462_macros.tex`, never here. |

```sh
cd /home/devel/electrical_notes
docs/latex/new_tex.sh   content/cpsc_462/hw/hw02 p01_some_problem
docs/latex/build_tex.sh content/cpsc_462/hw/hw02
docs/latex/flatten_tex.sh content/cpsc_462/hw/hw02      # -> overleaf/, upload from there

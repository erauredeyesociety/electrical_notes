...
\emph{Source:} \texttt{hw-lctr16-18.pdf} (markdown \texttt{hw-lctr16-18.md}). \emph{Solutions:} Not available; worked below.
...
\emph{Source:} \texttt{hw-lctr19-21.pdf}. \emph{Solutions:} \texttt{homework/hw6/hw6\_solutions.md}.
...
\emph{Source:} \texttt{lctr22-exercise.pdf}. Short-answer problems with standard sampling theorem reasoning.
...
\emph{Source:} \texttt{lctr23-exercise.pdf}. Worked solutions by standard block-diagram algebra.

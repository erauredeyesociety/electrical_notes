...
%
% Course-specific macros live beside the assignment, in
%   content/<course>/<kind>/reference_docs/<course>_macros.tex
% which is inputted AFTER this file. That split is the point: the page style,
% the answer box, and the problem header are identical everywhere, so they are
% defined once; \conv and \ustep mean something in DSP and nothing in a
% networks course, so they are not.
%
